...
class RegistryDownload extends SfCommand {
    ...
    async downloadAndExtract(server, type, name, version, registry, targetDirectory) {
        ...
        try {
            ...
            if (!res.body)
                this.error('Réponse HTTP sans body !');
...
function getDestination(targetDir, itemType, itemName) {

...
class RegistryTemplate extends SfCommand {
    ...
    createRegistryMetaJson(folder) {
        ...
        try {
            ...
            this.error(`❌ Erreur lors de la création du fichier meta: ${error instanceof Error ? error.message : String(error)}`);
        }
    }
}
